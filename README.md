# bon -- bash on node [![Build Status](https://img.shields.io/travis/orlin/bon.svg?style=flat)]()
...
Bon works best when paired with node.js cli scripts. It makes use of, or guesses,
